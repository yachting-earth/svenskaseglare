...
$$
\text{Vattenlinje} = 9{,}4 \text{ m} \times 3{,}25 = 30{,}83 \text{ fot}
$$
...
$$
\text{Skrovfart} = \sqrt{30{,}83} \times 1{,}34 = 7{,}44 \text{ knop}
$$

Föredrar du att räkna med meter istället för fot använder du istället:

$$
\text{Skrovfart} = \sqrt{9{,}4} \times 2{,}427 = 7{,}44 \text{ knop}
$$
...
$$
\text{Distans/min} = 7{,}44 \times 101{,}3 = 753{,}67 \text{ fot/min}
$$
...
$$
1369 \times 0{,}9 = 1232 \text{varv/min}
$$
...
$$
\text{Sträcka/Varv} = \frac{753{,}67}{1232} \times 12 = 7{,}33 \text{tum}
$$
...
$$
D = \times \frac{632{,}7 \times SHP^{0{,}2}}{RPM^{0{,}6}}
$$

Vilket i vårt fall ger

$$
D = \frac{632{,}7 \times 65^{0{,}2}}{1232^{0{,}6}} = 20{,}7 \text{tum}
$$
...
$$
Bladyta = \frac {100 \times SHP}{Skrovfart} \times \sqrt{Skrovfart}
$$

Vilket för oss betyder

$$
Bladyta = \frac{100 \times 65}{7{,}44} \times \sqrt{7{,}44} = 320 \text {tum}^2
$$
...
För dig som är intresserad av resultatet av bytet så hittar du det här --> [Efter vårt byte från en 16x11-tums propeller till en Flexofold 20x13-tums propeller](https://yachting.earth/2025/07/17/propeller.html).
