---
title: Vad kostar en sjömil under segel?
tags:
  - segling
created: 2026-07-23
updated: 2026-07-23
...
draft: true
---
Segel är dyrt. Det är väl ungefär den analysen de flesta av oss orkar med innan vi suckar, blundar och skriver under offerten från segelmakaren (om de inte köps i Italien då går går det bra med ett handslag och en notis i en liten svart bok bakom disken). Sedan hänger duken där uppe i ett antal säsonger tills den ser trött ut, blir bukig och börjar likna en gammal soppåse i kryss, varpå vi suckar en gång till och gör om proceduren.

Men vänta lite segel är ju faktiskt inte en kostnad, segel är bränsle. Det är den enda framdrivning ombord som vi betalar för så långt i förskott istället för som med diesel lite förlelat över säsongen, och det är just därför bränslen som sitter på masten känns så dyr. Ingen skulle klaga på ett par segel för 90 000 kronor om de levererades i 4500 dunkar om 20 liter utspridda över tio år.

Anledningen till att jag titta lite närmre på det här är för att ett par vänner precis bytt från segelbåt till en Elling E3, alltså en 46 fots holländsk trawler (en riktigt trevlig båt!!). På en läns norrut förbi Kosika började vi prata om det ombord på Freya och blev helt enkelt nyfikna. Inte på om segling är gratis, det vet vi ju redan att det inte är, utan på hur stor skillnaden faktiskt är när man ställer Freya bredvid deras nya skuta och räknar på samma sätt på båda.

Så jag gjorde det jag brukar göra: räknade på det. För först när du vet vad en sjömil faktiskt kostar kan du ha en åsikt om huruvida segel är dyrt eller inte. 

Och som vanligt: gillar du inte siffror är det ungefär här i texten som vi skiljs åt som vänner. :) 

## När är ett segel egentligen slut?

Det första man behöver reda ut är vad "slut" betyder, för segelmakare menar två helt olika saker med det ordet och det är sällan tydligt vilket av dem som säljs in när du pratar med en om du inte pressar dem lite...

**Formmässig livslängd** är hur länge seglet behåller den profil det ritades med. När duken börjar töja sig vandrar bukdjupet akterut, seglet blir bukigt, du får mer krängning och båten tar sämre höjd när du seglar. Seglet fungerar fortfarande alldeles utmärkt som segel. Det är bara långsammare och kränger mer på vissa bogar än när det var nytt.

**Mekanisk livslängd** är hur länge duken håller ihop rent strukturellt innan den spricker, delaminerar eller helt enkelt nöts sönder mot spridare, vant, mantåg eller vad det nu skaver mot när du seglar.

Skillnaden mellan de två är för vissa material enorm, och det är där hela ekonomin i ämnet gömmer sig.

| Material | Formmässig livslängd | Mekanisk livslängd | Hur det dör |
| --- | --- | --- | --- |
| Vävd Dacron | 300–500 h (3–5 säsonger) | 1 500–2 500+ h (10–20+ år) | Formen går först. Seglet blir bukigt men duken spricker sällan. |
| Cruisinglaminat | 600–1 000 h (5–8 säsonger) | 800–1 200 h (8–10 år) | Håller formen bra men dör av delaminering eller UV. |
| Membran / gjutna segel | 1 000–1 500+ h (8–12 säsonger) | 1 000–1 500 h (10–12 år) | Håller exakt profil nästan hela vägen. Spricker sedan mer eller mindre direkt. |

Titta på raden för vävd dacron en gång till. Formen är slut efter tre till fem säsonger, men duken kan hänga med i tjugo år. Det är därför halva klubbhamnen seglar med segel som är äldre än deras barn och tycker att det går alldeles utmärkt, samtidigt som kappseglaren i grannbåten byter garderob vart tredje år, båda tycker att den andra är galen. Båda har rätt. De pratar bara om två olika sorters livslängd.

För oss som seglar långt och länge är det just den distinktionen som avgör vad en sjömil kostar, eftersom vi själva bestämmer var på skalan mellan "fortfarande snabbt" och "fortfarande helt" vi vill lägga oss.

## Hydra Net, eller varför vi inte gillar lim

Våra segel är av Hydra Net är en hybridväv: tätt vävd polyester med ett heltäckande nät av Ultra-PE-fibrer (samma familj som Dyneema) invävt i strukturen. Poängen är att få laminatets formstabilitet utan laminatets största svaghet, nämligen att det till slut är limmet och inte fibern som bestämmer när seglet ska kasta in handsken och sluta vara segel.

Siffror jag använt, Då vi seglar runt 1500 sjömil under segel per år är det vad jag räknar på det motsvarar runt 375 timmar för segel per säsong. Det ger oss något åt det här resultatet:

- **Formmässig livslängd:** 8–12 säsonger, alltså cirka 3 000–4 500 timmars segling eller 12 000–18 000 sjömil.
- **Mekanisk livslängd:** 15–20+ år, någonstans mellan 25 000 och 35 000 sjömil.
- **Reparerbarhet:** kan lagas av oss själva med vår något kraftigare symaskin än vad som i regel står hemma i stugorna på land.

Den sista punkten är den som ingen räknar på men som betyder mest när man är långt hemifrån. Ett delaminerat (om skadan är stor) laminatsegel i en vik långt bort är ett problem som löses med kreditkort och väntetid. Ett trasigt Hydra Net är ett problem som löses med massor av svordommar då det är trångt att sy ombord. Det är ett värde i det som inte syns i offerten.

## Medelhavet och tropikerna äter dina segel
...
1. **UV.** UV-index ligger på 8–10+ lämngre söderut mot 4–6 hemma. Det är inte en liten skillnad, det är ungefär dubbelt så mycket energi som ska hanteras av samma fibrer och samma sytråd. Tråden går för övrigt oftast före duken.
2. **Saltkristallisering.** Högre salthalt betyder att när vattnet som hamnat på dina segel dunstar blir det kvar kristaller i väven. De kristallerna fungerar som slippapper varje gång duken rör sig.
3. **Värme.** Varmare segel är mjukare segel, vilket ger mer flex under belastning och därmed snabbare formförlust.

| Region | Formmässig livslängd (Hydra Net) | Mekanisk livslängd |
| --- | --- | --- |
| Skandinavien | 8–12 år (3 000–4 500 h) | 15–20+ år |
| Medelhavet | 5–8 år (2 000–3 000 h) | 10–12 år |

Notera att den mekaniska livslängden fortfarande är tio till tolv år. Seglet dör alltså inte i Medelhavet, det blir bara bukigt tidigare. Det är skillnaden mellan "jag måste köpa nytt segel" och "jag villhöver ett nytt segel", och det är också ungefär där jag misstänker att en stor del av segelbranschens marginaler bor, utöver alla charterbåtar som måste köpa nya segel då "kapten" och "besättningen" misshandlat båtens segel under en vecka eller två som om seglet stulit sista godisbiten i påsen efter att det slog sönder deras favoritleksak. (Yes, jag gillar fortfarande inte charterbåtar...)

## Så vad vad kostar formstabiliteten i fart?
...
Nu innan du får panik och loggar in på närmsta FaceBook-grupp om segling och skriver av dig om vilken jubelidiot jag är och ur rätt du har så ha i åtanke att siffrorna nedan handlar om "min båt" och "mina segel", inte vad du har hemma i TV-soffan eller på din båt... 
...
- **Segelgarderob:** Hydra Net storsegel 40 000 kr + genua 50 000 kr = **90 000 kr**.
- **Seglingsprofil:** 1 500 NM under segel per år, plus 750 NM för motor. Totalt 2 250 NM per år.
- **Motor:** Volvo Penta D2-75 (inte så viktigt men jag tar med det ändå))
- **Diesel:** 20 kr/liter.
- **Livslängd segel:** 10 år, alltså 15 000 NM under segel.

Det ger en ren segelkostnad på:

$$\frac{90\,000\text{ kr}}{15\,000\text{ NM}} = 6{,}00 \text{ kr/NM}$$

Sex kronor sjömilen för att duken ska sitta där uppe. Håll den siffran i huvudet, för nu ska vi ställa den mot alternativet.

### Vad kostar samma sjömil för motor?

Här får jag lov att bråka lite med underlaget. Analysen räknade med 3,2 liter i timmen vid 6 knop, vilket ger 0,53 l/NM. Det är en helt rimlig schablon för en D2-75, men det är inte Freyas siffra. Efter [propellerbytet](https://svenskaseglare.se/2025/07/17/propeller.html) har vi uppmätt 3,33 liter i timmen vid 7,1 knop, vilket ger 0,469 l/NM.
...
![Kostnad per sjömil för de olika alternativen](/assets/images/kostnad_per_sjomil.png)
...
### Och så Medelhavseffekten

Nu var ju hela poängen med förra avsnittet att seglen här nere inte håller formen i tio år utan snarare i fem till åtta. Så vad händer med kalkylen om vi säger åtta?
...
![Ackumulerad framdrivningskostnad över tio år](/assets/images/kostnad_tio_ar.png)
...
## Skalningseffekten: varför 38 fot är den ekonomiska sweet spoten

Okey, kanske lite partisk då vi har en 38 fötters båt men jag tror vill påstå att resonemanget fortfarande gäller när vi talar kronor och ören.

Här blir det intressant, för intuitivt tänker man att en större båt är lite dyrare. Det är fel. En större båt är mycket dyrare, och seglen är ett av de tydligaste exemplen även om alla pratar om hur dyra wischar är på en större segelbåt, precis som att man byter winchar stup i kvarten?!.
...
| --- | --- | --- |
| 45' segelbåt (Hydra Net 160k + D2-75) | 16 000 kr segel + 8 000 kr diesel = **24 000 kr** | **10,67 kr** |
...
## Och så den känsliga frågan: vad drar motorbåten egentligen?
...
## Elling E3, för den som inte känner till dem
...
## Jämförelsen, med rätt siffror den här gången
...
## Men vänta, vi går ju inte lika fort

Här är det lätt att lura sig själv.

Vid sex knop bränner Elling E3:an ungefär 3,0 liter i timmen. Freya bränner 3,33 liter i timmen. Deras 15-tonnare drar alltså mindre diesel per timme än vår 10-tons segelbåt, vilket låter som en imponerande poäng ända tills man kommer ihåg att Freya gör 7,1 knop på de literna. Vi kommer 1,1 sjömil längre för varje timme. Att jämföra liter per timme mellan två båtar som går i olika fart är ungefär lika meningsfullt som att jämföra bränsleförbrukning mellan en bil på motorvägen och en på parkeringen.
...
Freya är alltså 6,6 % snålare per sjömil **och** 18 % snabbare. Den jämförelsen vann vi, om än knappt.
...
Å andra sidan är vår kostnad känslig för något som deras inte alls är: solen. Om medelhavssolen äter våra segel på åtta år istället för tio stiger vår kostnad med 14 % utan att någonting alls hänt i omvärlden. Ellingens duk består av rostfritt och glasfiber och bryr sig inte nämnvärt om UV-index.
...
- Ett segel har två livslängder och det är du, inte segelmakaren, som bestämmer vilken av dem du ska betala för.
- Hydra Net ger laminatets formstabilitet med vävd dacrons hållbarhet och reparerbarhet, till priset av 2–3 grader i kryss och några tiondelar i lättvind. För touring och långfärd är det en av de bättre affärerna i marinbranschen.
- Medelhavet kortar den formmässiga livslängden med 30–40 %. Räkna med det i din kalkyl innan du seglar söderut, inte efteråt.
- Vid runt 38 fot kostar en sjömil under segel ungefär 7 kronor mot 9–10 kronor att gå för motor med samma båt. Vid 45 fot är den fördelen borta.
- En Elling E3 i sex knop kostar 10 kronor sjömilen. Skillnaden mot att segla Freya är 2,87 kr/NM, alltså ett storsegel på tio år. Betydligt mindre än vi trodde innan vi räknade.
- Men Ellingens kostnad är en funktion av gasreglaget. Sexton knop kostar 7,6 gånger mer per sjömil än sex, och räckvidden faller från 3 000 till 400 sjömil. Segelbåtens kostnad rör sig inte alls med farten.
- Vår kostnad är exponerad mot solen, deras mot dieselpriset. Två olika risker, ungefär samma nivå.
- Jämför alltid liter per **sjömil**, aldrig liter per timme. Per timme ser Ellingen snålare ut, per sjömil är Freya snålare och dessutom snabbare. Farten göms i timmen.
- Räkna på **din** båt med **dina** uppmätta siffror. Vår motor drar 0,469 l/NM, inte 0,53 som schablonen sa, och det ensamt flyttade slutsatsen med tusenlappar per år.
